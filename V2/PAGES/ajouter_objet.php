...
<body>
    <div class="container">
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <label>Images (max 2 Mo, JPEG/PNG) :</label>
            <input type="file" name="images[]" multiple accept="image/jpeg,image/png"><br>
            <button type="submit" name="ajouter_objet">Ajouter</button>
        </form>
